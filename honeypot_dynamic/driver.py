...
if __name__ == "__main__":
    ...
    out_csv = '/home/quanghuyngo/Desktop/CFR/Code/honeypot/result/result' + "_" + str(args['fn']) + "_" + str(args['budget']) + "_" + str(args['start_node_number']) + "_" + str(args['blockable_p'])  +".csv"
    df.to_csv(out_csv)
    print(df)
    ...
    # print(result)
    store = {"items": []}
    out_json = '/home/quanghuyngo/Desktop/CFR/Code/honeypot/result/result' + "_" + str(args['fn']) + "_" + str(args['budget']) + "_" + str(args['start_node_number']) + "_" + str(args['blockable_p'])  +".json"
