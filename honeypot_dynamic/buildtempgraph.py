...
if __name__ == "__main__":
    ...
    with open(f"//Users/huyngo/Desktop/Research/honeypot_dynamic/processed_dygraph/auth_{graph_name}_{day_of_data}_{interarrival_mean}_{new_edge_rate_mean}_{seed}.pickle", "wb") as fp:   #Pickling
        pickle.dump(auth, fp)
    write_gpickle(CG, f"//Users/huyngo/Desktop/Research/honeypot_dynamic/processed_dygraph/temporal_{graph_name}_{day_of_data}_{interarrival_mean}_{new_edge_rate_mean}_{seed}.gpickle")
