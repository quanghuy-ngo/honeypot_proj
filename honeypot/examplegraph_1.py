...
DG[4][3]["blockable"] = True
DG[5][3]["blockable"] = True
DG[6][4]["blockable"] = True
DG[6][5]["blockable"] = True

for v in range(10, 13):
    DG.add_edge(v, 6)
    DG.nodes[v]["node_type"] = "S"
    DG.nodes[v]["layer"] = 0
    DG[v][6]["blockable"] = True
...
write_gpickle(DG, "/home/andrewngo/Desktop/CFR/AAAI/examplegraph_1.gpickle")
